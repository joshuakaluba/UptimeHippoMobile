export default StringDictionary = {
  ...
  invalidPassword:
    "Please enter a valid password. Password should be at least 6 characters",
  keyWord: "Keyword",
  ...
  name: "Name",
  noMonitorLogs:
    "No monitor logs have been created for this monitor. Check back in a bit.",
  noMonitors: "You currently have no monitors",
  ok: "Ok",
  password: "Password",
  pleaseIncludeProtocol:
    "Please include the required http or https protocol (e.g http://example.com or https:example.com",
  port: "Port",
